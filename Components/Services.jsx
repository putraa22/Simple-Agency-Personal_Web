...
const Services = ({ services }) => {
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.subtitle}>Services we can help you with us</h1>
            ...
            <div className={styles.service}>
              ...
              <div className={styles.media}>
                {service.video ? (
                  ...
                  <Image src={`/img/${service.photo}`} width="100%" height="100%" layout="responsive" objectFit="cover" alt="photo product" />
                )}
              </div>
            </div>
          </Link>
